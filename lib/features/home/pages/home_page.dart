import 'package:cantwait28/auth/pages/user_profile.dart';
import 'package:cantwait28/details/pages/details_page.dart';
      ...
      child: BlocBuilder<HomeCubit, HomeState>(
        builder: (context, state) {
          ...
          return ListView(
            ...
            children: [
              for (final itemModels in itemModels)
                Dismissible(
                  key: ValueKey(itemModels.id),
                  ...
                  onDismissed: (direction) {
                    context.read<HomeCubit>().remove(documentID: itemModels.id);
                  },
                  child: _ListViewItem(
